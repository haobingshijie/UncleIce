...
//            ->queryOne();
//        返回的是对象
//        $model = Post::find()->where(['id'=>36])->one();
//        $models = Post::find()->where(['status'=>2])->all();
//        $model = Post::findOne(36);
//        $models = Post::findAll(['status'=>2]);
//        $models = Post::find()->where(['AND',['status'=>2],['Like','title','Yii2']])->orderBy('id')->all();
//        $post = Post::findBySql('select * from post where status=2')->all();
//        var_dump($post);
//        exit(0);
